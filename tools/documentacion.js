  ...
  const TRAMITES = {
    ...
    laboral_actora_despido: {
      ...
      items: [
        ...
        'Recibos de sueldo (últimos 12 meses o los que conserve)',
        'Contrato de trabajo o certificado de trabajo, si lo tiene',
        'Telegramas y cartas documento cursadas y recibidas (intimaciones, despido, etc.)',
        'Certificado de trabajo y de servicios y remuneraciones (art. 80 LCT), si el empleador lo entregó',
        'Detalle de fecha de ingreso, categoría, jornada y tareas realizadas',
        'Constancia de CBU / cuenta bancaria donde se acreditaba el sueldo',
        'Datos de la ART del empleador, si se conocen',
        'Certificados médicos, si el reclamo se vincula con una enfermedad o accidente',
        'Nombre y contacto de testigos que puedan acreditar la relación laboral y las condiciones de trabajo',
        'Constancia de denuncia ante el Ministerio de Trabajo / SECLO, si se inició',
        'Carta poder / poder para pleitos a favor del estudio',
      ],
    },
    laboral_demandada: {
    ...
    art_trabajador: {
      label: 'ART — Riesgos del Trabajo (Trabajador/a)',
      items: [
        'DNI del trabajador/a',
        'Denuncia del accidente o enfermedad ante la ART (formulario y número de siniestro)',
        'Historia clínica y estudios médicos (radiografías, resonancias, informes, etc.)',
        'Certificados médicos de diagnóstico, reposo y alta',
        'Dictamen de la Comisión Médica, si ya se expidió',
        'Recibos de sueldo de los últimos 12 meses',
        'Contrato de trabajo o certificado de trabajo',
        'Constancia de cobertura de ART vigente al momento del hecho y datos de la aseguradora',
        'Fotografías del lugar o mecánica del accidente, si las hay',
        'Nombre y contacto de testigos del accidente',
        'Telegramas y cartas documento cruzadas con el empleador o la ART, si hubo reclamo previo',
        'Carta poder / poder para pleitos a favor del estudio',
      ],
    },
    danios_consumidor: {
