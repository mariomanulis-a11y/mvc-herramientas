...
export function initCartaDocumento(container) {
  ...
  const RAMAS_CD = {
    laboral: {
      ...
      plantillas: {
        intim_registro: {
          label: 'Intimación registro laboral (Art. 52 LCT / ex Ley 24.013)',
          requiere: ['nombre','dni','domicilio','razon_social','cuit','dom_destinatario','fecha_ingreso'],
          opcionales: ['remuneracion'],
          generar: (d) => `Me dirijo a Ud. en mi carácter de trabajador/a en relación de dependencia de ${d.razon_social}, CUIT ${d.cuit}, con domicilio en ${d.dom_destinatario}, a fin de intimarlo/a en los términos del art. 47 del dec. 1043/2001 y art. 52 de la LCT (texto según art. 20, Ley 27.802) para que en el plazo de TREINTA (30) días hábiles proceda a: 1) Registrar debidamente ante la ARCA (Agencia de Recaudación y Control Aduanero) la relación laboral que me une a su empresa desde el día ${d.fecha_ingreso}; 2) Consignar mi remuneración real de ${d.remuneracion ? '$ ' + d.remuneracion + ' mensuales' : '[REMUNERACIÓN A COMPLETAR]'}. Bajo apercibimiento de reclamar los daños y perjuicios que dicho incumplimiento me ocasione, cuantificados conforme la pauta objetiva de los arts. 8, 9 y 10 de la Ley 24.013 (derogados por arts. 99-100, Ley 27.742, B.O. 8/7/2024, vigencia 9/7/2024) y arts. 1716, 1717, 1738 y 1740 del Código Civil y Comercial de la Nación. Reservo acciones. Hago extensiva la presente notificación a la ARCA conforme art. 47 del decreto mencionado.`,
        },
        intim_despido: {
          label: 'Notificación de despido indirecto (Art. 246 LCT)',
          requiere: ['nombre','dni','domicilio','razon_social'],
          opcionales: ['incumplimiento'],
          generar: (d) => `Me dirijo a Ud. a fin de manifestarle que me considero gravemente injuriado/a y despedido/a en forma indirecta con causa imputable a Ud. en los términos del art. 246 en función del art. 242 de la LCT, en virtud de ${d.incumplimiento ? d.incumplimiento : '[DESCRIBIR INCUMPLIMIENTO]'}. Intimo al pago de los rubros emergentes del distracto en el plazo del art. 128 LCT, bajo apercibimiento de reclamar, en concepto de daño y perjuicio de derecho común (arts. 1716, 1717, 1738 y 1740 CCyC) por la mora en dicho pago, una suma equivalente a la que preveía el art. 2 de la ley 25.323 (derogado por art. 55, DNU 70/2023, ratificado por Ley 27.742, B.O. 8/7/2024) — CINCUENTA POR CIENTO (50%) adicional sobre dichos conceptos. Reservo todo otro derecho.`,
        },
        telegrama_reserva: {
          label: 'Telegrama reserva de acciones (Art. 243 LCT)',
          requiere: ['razon_social','fecha_hecho'],
          opcionales: ['nombre'],
          generar: (d) => `Me dirijo a Ud. en mi carácter de trabajador/a dependiente de ${d.razon_social} a efectos de notificarle que con fecha ${d.fecha_hecho} he iniciado acciones laborales reclamando los conceptos derivados de la relación laboral. Reservo acciones. Notifico a la ARCA (Agencia de Recaudación y Control Aduanero).`,
        },
        intim_haberes: {
          label: 'Intimación pago de haberes',
          requiere: ['razon_social'],
          opcionales: ['mes_anio','remuneracion'],
          generar: (d) => `Intimo a Ud. por la presente al pago de haberes del mes de ${d.mes_anio ? d.mes_anio : '[MES/AÑO]'} por la suma de ${d.remuneracion ? '$ ' + d.remuneracion : '[MONTO]'} y/o los que correspondan, en el plazo de cuarenta y ocho (48) horas, bajo apercibimiento de considerarme en situación de despido indirecto con causa (art. 246 LCT) y reclamar, como daño y perjuicio por la mora (arts. 1716, 1717, 1738 y 1740 CCyC), el recargo del 50% que preveía el art. 2 de la ley 25.323 (hoy derogado por art. 55, DNU 70/2023, ratificado por Ley 27.742).`,
        },
        intim_certificados: {
          label: 'Intimación entrega de certificados (Art. 80 LCT)',
          requiere: ['razon_social'],
          opcionales: [],
          generar: () => `Intimo a Ud. en los términos del art. 80 LCT (texto según art. 25, Ley 27.802 — plazo de CUARENTA Y CINCO (45) días hábiles desde la extinción) y decreto 146/2001 para que me haga entrega del certificado de trabajo, certificado de servicios y aportes, y constancia de extinción de la relación laboral, bajo apercibimiento de reclamar, en concepto de daño y perjuicio de derecho común (arts. 1716, 1717, 1738 y 1740 CCyC), una suma equivalente a TRES (3) veces la mejor remuneración mensual, normal y habitual — pauta objetiva que preveía el ex art. 45 de la Ley 25.345 (que incorporaba dicha indemnización al art. 80 LCT, derogado por art. 99, Ley 27.742, B.O. 8/7/2024, vigencia 9/7/2024).`,
        },
        ley25323: {
          label: 'Intimación fehaciente — Daño por Mora en el Pago (ex Ley 25.323)',
          requiere: ['razon_social','fecha_hecho'],
          opcionales: [],
          generar: (d) => `Intimo a Ud. para que en el plazo de veinticuatro (24) horas abone las indemnizaciones por despido previstas en los arts. 232, 233 y 245 de la LCT que se encuentran impagas desde el ${d.fecha_hecho}, bajo apercibimiento de reclamar, en concepto de daño y perjuicio de derecho común por la mora en el pago (arts. 1716, 1717, 1738 y 1740 del Código Civil y Comercial de la Nación), una suma equivalente al recargo del CINCUENTA POR CIENTO (50%) sobre dichos conceptos que preveía el art. 2 de la ley 25.323 (derogado por art. 55, DNU 70/2023, B.O. 21/12/2023, ratificado por el Congreso mediante Ley 27.742, B.O. 8/7/2024, vigencia 9/7/2024; ver STJ Corrientes, "Guastavino c/ Corsal S.A.", sent. 45 del 14/4/2026).`,
        },
      },
    },
    ...
    salud: {
      label: 'Derecho a la Salud (pre-amparo)',
      remitenteLabel: 'Paciente / persona afectada (remitente)',
      destinatarioLabel: 'Obra Social / Prepaga / Estado / ART / Mutual (destinatario)',
      detalleLabel: 'Datos del hecho de salud',
      revisionPendiente: true,
      plantillas: {
        salud_medicamento_alto_costo: {
          label: 'Cobertura de medicamento de alto costo / enfermedad poco frecuente',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','diagnostico','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['numero_afiliado','medico_tratante','fecha_prescripcion','monto_reclamado','urgencia_salud'],
          generar: (d) => `Por medio de la presente, en mi carácter de afiliado/a a su cobertura de salud${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''}, hago saber a Ud. que padezco ${d.diagnostico}, requiriendo el siguiente tratamiento/medicación: ${d.tratamiento_prescripto}${d.medico_tratante ? `, conforme lo prescripto por mi médico/a tratante, Dr./Dra. ${d.medico_tratante}${d.fecha_prescripcion ? ` con fecha ${d.fecha_prescripcion}` : ''}` : ''}. Que con fecha ${d.fecha_solicitud} solicité a Ud. la cobertura integral de dicho tratamiento${d.monto_reclamado ? `, cuyo costo asciende a $ ${d.monto_reclamado}` : ''}, sin haber obtenido respuesta favorable a la fecha, no siendo válida una referencia histórica al estado del conocimiento médico existente al momento de fijarse los términos de la cobertura para negar los adelantos terapéuticos que incorpora el progreso científico (CSJN, Fallos: 337:471; 325:677). Intimo a Ud. para que en el plazo de CUARENTA Y OCHO (48) horas proceda a brindar la cobertura integral requerida, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación), sin perjuicio de la denuncia que pudiera corresponder ante la Superintendencia de Servicios de Salud y/o la autoridad de contralor pertinente${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_cobertura_no_pmo: {
          label: 'Cobertura de práctica, cirugía o tratamiento no incluido en el PMO',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','diagnostico','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['numero_afiliado','incumplimiento','monto_reclamado','urgencia_salud'],
          generar: (d) => `Por medio de la presente, en mi carácter de afiliado/a a su cobertura de salud${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''}, hago saber a Ud. que padezco ${d.diagnostico}, requiriendo la práctica/tratamiento consistente en ${d.tratamiento_prescripto}. Que con fecha ${d.fecha_solicitud} solicité su cobertura${d.incumplimiento ? `, siendo respondido/a que ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}. Hago saber que los anexos del Programa Médico Obligatorio establecen una cobertura mínima que resulta complementaria y subsidiaria, sin que su enfoque restrictivo pueda vedar el acceso a una terapéutica más moderna y segura (CSJN, Fallos: 337:471; 329:1638). Intimo a Ud. para que en el plazo de CINCO (5) días hábiles proceda a brindar la cobertura integral requerida, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación), sin perjuicio de la denuncia que pudiera corresponder ante la Superintendencia de Servicios de Salud y/o la autoridad de contralor pertinente${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_discapacidad_ley24901: {
          label: 'Prestaciones por discapacidad (Ley 24.901)',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','diagnostico','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['numero_afiliado','certificado_discapacidad','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente, en mi carácter de${d.certificado_discapacidad ? ` titular del Certificado Único de Discapacidad ${d.certificado_discapacidad} y` : ''} afiliado/a a su cobertura de salud${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''}, hago saber a Ud. que padezco ${d.diagnostico}, requiriendo la prestación consistente en ${d.tratamiento_prescripto}. Que con fecha ${d.fecha_solicitud} solicité dicha prestación${d.incumplimiento ? `, siendo respondido/a que ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}. Fundo el presente en la Ley 24.901 y en la Convención sobre los Derechos de las Personas con Discapacidad (ley 26.378, jerarquía constitucional conforme ley 27.044), en tanto la protección integral de la discapacidad no admite interpretaciones restrictivas que conduzcan a resultados regresivos (CSJN, Fallos: 343:848; 327:2413). Intimo a Ud. para que en el plazo de CINCO (5) días hábiles proceda a brindar la prestación requerida, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación), sin perjuicio de la denuncia que pudiera corresponder ante la autoridad de contralor pertinente${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_mental: {
          label: 'Salud mental — tratamiento, internación o acompañamiento terapéutico (Ley 26.657)',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','diagnostico','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['numero_afiliado','medico_tratante','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente, en mi carácter de afiliado/a a su cobertura de salud${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''}, hago saber a Ud. que padezco ${d.diagnostico}, requiriendo ${d.tratamiento_prescripto}${d.medico_tratante ? `, conforme lo prescripto por mi profesional tratante, Dr./Dra. ${d.medico_tratante}` : ''}. Que con fecha ${d.fecha_solicitud} solicité la cobertura correspondiente${d.incumplimiento ? `, siendo denegada/discontinuada con el argumento de que ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}. Fundo el presente en la Ley Nacional de Salud Mental N° 26.657 y su decreto reglamentario 603/2013 [verificar articulado específico antes de presentar], sin que la existencia de una afección preexistente pueda constituir per se causal de exclusión de cobertura. Intimo a Ud. para que en el plazo de CUARENTA Y OCHO (48) horas proceda a brindar/restablecer la cobertura requerida, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación), sin perjuicio de la denuncia que pudiera corresponder ante la Superintendencia de Servicios de Salud y/o la autoridad de contralor pertinente${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_trha: {
          label: 'Reproducción médicamente asistida (Ley 26.862)',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['numero_afiliado','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente, en mi carácter de afiliado/a a su cobertura de salud${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''}, hago saber a Ud. que requiero el tratamiento de reproducción médicamente asistida consistente en ${d.tratamiento_prescripto}. Que con fecha ${d.fecha_solicitud} solicité su cobertura${d.incumplimiento ? `, siendo respondido/a que ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}. Fundo el presente en la Ley 26.862 de Reproducción Médicamente Asistida y su decreto reglamentario 956/2013 [verificar articulado específico antes de presentar], norma de orden público y de aplicación en todo el territorio de la República Argentina (CSJN, Fallos: 346:1461). Intimo a Ud. para que en el plazo de CINCO (5) días hábiles proceda a brindar la cobertura requerida, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_hiv: {
          label: 'HIV / SIDA — cobertura de tratamiento (Leyes 23.798 y 24.455)',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['numero_afiliado','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente, en mi carácter de afiliado/a a su cobertura de salud${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''}, hago saber a Ud. que requiero ${d.tratamiento_prescripto} en el marco de mi tratamiento por HIV/SIDA. Que con fecha ${d.fecha_solicitud} solicité su cobertura${d.incumplimiento ? `, siendo respondido/a que ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}. Fundo el presente en la Ley 23.798 y en las Leyes 24.455 y 24.754 [verificar articulado específico antes de presentar], que establecen la cobertura obligatoria de las prestaciones vinculadas al HIV (CSJN, Fallos: 324:754; 323:1339). Intimo a Ud. para que en el plazo de CUARENTA Y OCHO (48) horas proceda a brindar/restablecer la cobertura requerida, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_cannabis_medicinal: {
          label: 'Cannabis medicinal (Ley 27.350)',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','diagnostico','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['numero_afiliado','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente, en mi carácter de afiliado/a a su cobertura de salud${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''}, hago saber a Ud. que padezco ${d.diagnostico}, requiriendo ${d.tratamiento_prescripto} en base a cannabis y sus derivados. Que con fecha ${d.fecha_solicitud} solicité su cobertura${d.incumplimiento ? `, siendo respondido/a que ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}. Fundo el presente en la Ley 27.350 y su decreto reglamentario 883/2020 [verificar articulado específico antes de presentar], que imponen su cobertura a cargo de los agentes del Sistema Nacional del Seguro de Salud y de las entidades de medicina prepaga. Intimo a Ud. para que en el plazo de CINCO (5) días hábiles proceda a brindar la cobertura requerida, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_transplante: {
          label: 'Trasplante de órganos, tejidos o células',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','diagnostico','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['numero_afiliado','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente, en mi carácter de afiliado/a a su cobertura de salud${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''}, hago saber a Ud. que padezco ${d.diagnostico}, requiriendo ${d.tratamiento_prescripto} en el marco de un proceso de trasplante. Que con fecha ${d.fecha_solicitud} solicité su cobertura${d.incumplimiento ? `, siendo respondido/a que ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}, circunstancia que pone en grave e inminente riesgo mi vida. Fundo el presente en la Ley 27.447 de Trasplante de Órganos, Tejidos y Células [verificar articulado específico antes de presentar]. Intimo a Ud. para que en el plazo de VEINTICUATRO (24) horas proceda a brindar la cobertura requerida, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_tercera_edad: {
          label: 'Persona mayor — cobertura o continuidad de prestaciones',
          requiere: ['nombre','dni','domicilio','edad','razon_social','dom_destinatario','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['numero_afiliado','diagnostico','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente, de ${d.edad} años de edad${d.diagnostico ? ` y padeciendo ${d.diagnostico}` : ''}, en mi carácter de afiliado/a a su cobertura de salud${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''}, hago saber a Ud. que requiero ${d.tratamiento_prescripto}. Que con fecha ${d.fecha_solicitud} solicité su cobertura${d.incumplimiento ? `, siendo respondido/a que ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}. Fundo el presente en la Convención Interamericana sobre Protección de los Derechos Humanos de las Personas Mayores, siendo la vía del amparo particularmente pertinente cuando el peticionario pertenece a dicho colectivo (CSJN, Fallos: 345:1174). Intimo a Ud. para que en el plazo de CINCO (5) días hábiles proceda a brindar la cobertura requerida, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_incompatibilidad_coberturas: {
          label: 'Incompatibilidad o superposición de coberturas',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','cobertura_actual','cobertura_pretendida'],
          opcionales: ['numero_afiliado','certificado_discapacidad','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente,${d.certificado_discapacidad ? ` titular del Certificado Único de Discapacidad ${d.certificado_discapacidad},` : ''} hago saber a Ud. que cuento actualmente con la cobertura de ${d.cobertura_actual}, y requiero adicionalmente/alternativamente la cobertura de ${d.cobertura_pretendida}${d.incumplimiento ? `, habiéndoseme informado que ${d.incumplimiento}` : ''}. Fundo el presente en la Ley 24.901 y en la Convención sobre los Derechos de las Personas con Discapacidad (ley 26.378/27.044), en tanto ninguna norma reglamentaria de rango infralegal puede prevalecer sobre dichas garantías en desmedro de la cobertura de salud necesaria (CSJN, Fallos: 343:848, disidencia del juez Rosatti). Intimo a Ud. para que en el plazo de CINCO (5) días hábiles proceda a garantizar ambas coberturas sin exigir renuncia alguna, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_vacunacion: {
          label: 'Vacunación / calendario nacional de inmunización',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente, hago saber a Ud. que requiero ${d.tratamiento_prescripto}, conforme el Calendario Nacional de Vacunación. Que con fecha ${d.fecha_solicitud} solicité su provisión/aplicación${d.incumplimiento ? `, siendo respondido/a que ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}. El Estado Argentino ha asumido compromisos internacionales dirigidos a promover y facilitar las prestaciones de salud, no pudiendo desligarse válidamente de esos deberes (CSJN, Fallos: 335:888). Intimo a Ud. para que en el plazo de CINCO (5) días hábiles proceda a dar cumplimiento a lo requerido, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_rescision_unilateral: {
          label: 'Rescisión unilateral o negativa de renovación por preexistencia (prepaga)',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','fecha_hecho','incumplimiento'],
          opcionales: ['numero_afiliado','diagnostico','tratamiento_prescripto','urgencia_salud'],
          generar: (d) => `Por medio de la presente, hago saber a Ud. que con fecha ${d.fecha_hecho} me notificó la rescisión unilateral del contrato / la negativa de renovación de mi afiliación${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''}, invocando como fundamento: ${d.incumplimiento}${d.tratamiento_prescripto ? `, decisión que interrumpe el tratamiento consistente en ${d.tratamiento_prescripto}` : ''}${d.diagnostico ? ` que requiero en razón de padecer ${d.diagnostico}` : ''}. Fundo el presente en la Ley 26.682 de Marco Regulatorio de Medicina Prepaga [verificar articulado específico sobre rescisión y preexistencias antes de presentar], conforme a la cual las entidades de medicina prepaga tienen a su cargo una trascendental función social que excede el mero interés comercial, no pudiendo desconocer un contrato para apartarse de las obligaciones legalmente impuestas (CSJN, Fallos: 330:3725). Intimo a Ud. para que en el plazo de CINCO (5) días hábiles proceda a dejar sin efecto la rescisión/negativa y a restablecer mi cobertura, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_aumento_cuota_dnu70: {
          label: 'Aumento desmedido de cuota (DNU 70/2023)',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','fecha_hecho','monto_cuota_anterior','monto_cuota_nueva'],
          opcionales: ['numero_afiliado','urgencia_salud'],
          generar: (d) => `Por medio de la presente, hago saber a Ud. que, siendo afiliado/a a su cobertura${d.numero_afiliado ? ` (N° de afiliado ${d.numero_afiliado})` : ''} y abonando una cuota mensual de $ ${d.monto_cuota_anterior}, con fecha ${d.fecha_hecho} me notificó un incremento de dicha cuota a la suma de $ ${d.monto_cuota_nueva}, invocando la desregulación dispuesta por el Decreto de Necesidad y Urgencia N° 70/2023, sin que conste autorización previa de la Superintendencia de Servicios de Salud [verificar el estado actual de la jurisprudencia y de los eventuales acuerdos homologados sobre el DNU 70/2023 antes de presentar, por tratarse de un extremo especialmente cambiante]. Dicho incremento resulta desproporcionado y pone en riesgo la continuidad de mi cobertura de salud. Intimo a Ud. para que en el plazo de CINCO (5) días hábiles proceda a dejar sin efecto el incremento cuestionado y a retrotraer el valor de la cuota, bajo apercibimiento de formular la denuncia pertinente ante la Superintendencia de Servicios de Salud y de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_migrantes: {
          label: 'Migrantes sin cobertura — residencia precaria / arancelamiento provincial',
          requiere: ['nombre','domicilio','razon_social','dom_destinatario','diagnostico','tratamiento_prescripto'],
          opcionales: ['dni','situacion_migratoria','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente,${d.situacion_migratoria ? ` en mi condición de ${d.situacion_migratoria},` : ' de nacionalidad extranjera,'} hago saber a Ud. que padezco ${d.diagnostico}, requiriendo ${d.tratamiento_prescripto}${d.incumplimiento ? `, habiéndoseme negado y/o condicionado la atención invocando ${d.incumplimiento}` : ', habiéndoseme negado y/o condicionado la atención en razón de mi situación migratoria'}. Fundo el presente en el art. 8 de la Ley 25.871 de Migraciones, que garantiza a todo migrante, independientemente de su situación migratoria, el acceso igualitario a la salud, no pudiendo negársele ni restringírsele en ningún caso dicho acceso, conforme asimismo lo señalado por la Corte Interamericana de Derechos Humanos en materia de acceso a la salud sin discriminación por origen nacional o condición migratoria [verificar la normativa provincial específica de arancelamiento vigente antes de presentar]. Intimo a Ud. para que en el plazo de CUARENTA Y OCHO (48) horas proceda a brindar la atención/cobertura requerida sin condicionamiento alguno, bajo apercibimiento de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_geriatrico: {
          label: 'Persona mayor institucionalizada — tutela en residencia geriátrica (PBA)',
          requiere: ['nombre','dni','domicilio','edad','razon_social','dom_destinatario','tratamiento_prescripto'],
          opcionales: ['diagnostico','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente, de ${d.edad} años de edad, alojado/a en la residencia geriátrica de referencia${d.diagnostico ? ` y padeciendo ${d.diagnostico}` : ''}, hago saber a Ud. que requiero ${d.tratamiento_prescripto}${d.incumplimiento ? `, habiéndose denegado u omitido dicha prestación invocando ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}. Fundo el presente en la Ley 14.263 de la Provincia de Buenos Aires y su decreto reglamentario 1190/2012, de los cuales se desprende la responsabilidad primaria del Estado provincial y municipal en la tutela de los derechos a la vivienda y a la salud de las personas institucionalizadas (CSJN, Fallos: 343:283) [advertencia: el trámite específico ante fuero provincial se rige por la Ley 13.928 de Amparo de la Pcia. de Bs. As., no verificada en esta versión]. Intimo a Ud. para que en el plazo de CINCO (5) días hábiles proceda a brindar la prestación requerida, bajo apercibimiento de iniciar de manera inmediata acción de amparo con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
        salud_art_cobertura: {
          label: 'ART — Cobertura de tratamiento, rehabilitación o internación (Ley 24.557)',
          requiere: ['nombre','dni','domicilio','razon_social','dom_destinatario','diagnostico','tratamiento_prescripto','fecha_solicitud'],
          opcionales: ['numero_afiliado','incumplimiento','urgencia_salud'],
          generar: (d) => `Por medio de la presente, hago saber a Ud. que a raíz de un accidente de trabajo/enfermedad profesional que me ocasionó ${d.diagnostico}${d.numero_afiliado ? ` (siniestro/expediente N° ${d.numero_afiliado})` : ''}, requiero ${d.tratamiento_prescripto}. Que con fecha ${d.fecha_solicitud} solicité dicha prestación${d.incumplimiento ? `, siendo respondido/a que ${d.incumplimiento}` : ', sin haber obtenido respuesta favorable a la fecha'}. Fundo el presente en la Ley 24.557 de Riesgos del Trabajo (arts. 20 y 26 y ccdtes.) y en los decretos de necesidad y urgencia 367/2020, 39/2021, 266/2021, 345/2021 y 413/2021 [verificar vigencia de los DNU citados antes de presentar], en cuanto imponen a la Aseguradora de Riesgos del Trabajo el deber de brindar las prestaciones en especie necesarias para mi recuperación (CSJN, Fallos: 346:1196). Intimo a Ud. para que en el plazo de CUARENTA Y OCHO (48) horas proceda a brindar la prestación requerida, bajo apercibimiento de formular la denuncia pertinente ante la Superintendencia de Riesgos del Trabajo y de iniciar de manera inmediata acción de amparo (art. 43, Constitución Nacional; Ley 16.986) con medida cautelar (art. 230 y ccdtes., Código Procesal Civil y Comercial de la Nación)${d.urgencia_salud ? `, toda vez que ${d.urgencia_salud}` : ''}, con reserva del derecho a reclamar los daños y perjuicios ocasionados y las costas del proceso.`,
        },
      },
    },
  };
  ...
  const CAMPOS_CONFIG = [
    ...
    // Detalle — salud (pre-amparo)
    { id: 'edad',            label: 'Edad',                              placeholder: '72',                     tipo: 'number', grupo: 'remitente' },
    { id: 'certificado_discapacidad', label: 'CUD — N° y/o vigencia (opcional)', placeholder: 'CUD N° 12345, vigente hasta 2028', tipo: 'text', grupo: 'remitente' },
    { id: 'situacion_migratoria', label: 'Situación migratoria (opcional)', placeholder: 'nacionalidad boliviana, residencia precaria en trámite', tipo: 'text', grupo: 'remitente' },
    { id: 'numero_afiliado', label: 'N° de afiliado / siniestro (opcional)', placeholder: '0000-1234567-8',      tipo: 'text',  grupo: 'destinatario' },
    { id: 'diagnostico',     label: 'Diagnóstico / enfermedad',           placeholder: 'esclerosis múltiple',    tipo: 'textarea', grupo: 'detalle' },
    { id: 'tratamiento_prescripto', label: 'Tratamiento/prestación requerida', placeholder: 'medicación X, 1 ampolla mensual', tipo: 'textarea', grupo: 'detalle' },
    { id: 'medico_tratante', label: 'Médico/a tratante (opcional)',       placeholder: 'Dra. Pérez, MP 12345',   tipo: 'text',  grupo: 'detalle' },
    { id: 'fecha_prescripcion', label: 'Fecha de la prescripción médica (opcional)', placeholder: '', tipo: 'date', grupo: 'detalle' },
    { id: 'fecha_solicitud', label: 'Fecha de solicitud a la demandada',  placeholder: '',                       tipo: 'date',  grupo: 'detalle' },
    { id: 'monto_cuota_anterior', label: 'Monto de cuota anterior',       placeholder: '74000',                  tipo: 'number', grupo: 'detalle' },
    { id: 'monto_cuota_nueva', label: 'Monto de cuota nueva',             placeholder: '141000',                 tipo: 'number', grupo: 'detalle' },
    { id: 'cobertura_actual', label: 'Cobertura actual',                 placeholder: 'Pensión No Contributiva por discapacidad', tipo: 'text', grupo: 'detalle' },
    { id: 'cobertura_pretendida', label: 'Cobertura pretendida',         placeholder: 'afiliación a PAMI',       tipo: 'text',  grupo: 'detalle' },
    { id: 'urgencia_salud',  label: 'Motivo de urgencia (peligro en la demora, opcional)', placeholder: 'la interrupción del tratamiento agravará mi cuadro y generará daños irreversibles', tipo: 'textarea', grupo: 'detalle' },
  ];
